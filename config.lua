...
Config.VetJob = {{job = 'vet', grade = 1}, {job = 'wapiti', grade = 2}}
...
Config.Care = {
    ...
    Items = {
        ...
        food = {
            ...
            ["horse_treat1"] = 2,
            ["product_apple"] = 1,
            ["horse_apache_treat"] = 1
        },
        -- Léky: "název_itemu" = kolik % zdraví doplní
        medicine = {
            ["horse_heal_1"] = 20,
            ["horse_heal_2"] = 50,
            ["shaman_horse_mix_1"] = 30,
            ["shaman_horse_mix_2"] = 30
        },
        -- Speciální itemy
...
-- LIMIT MNOŽENÍ
Config.MaxActiveBreedings = 3 -- Kolik může mít jeden hráč aktivních množení najednou

-- ÚPRAVA PÉČE (CARE)
Config.Care.FoodDecayPerHour = 1 -- Kolik bodů jídla ubyde každou hodinu
Config.Care.HealthDecayPerHour = 5 -- Kolik % zdraví ubyde, pokud je jídlo pod 30%

-- OMEZENÍ PLEMEN PRO JOBY
Config.BreedLimits = {
    enabled = true, -- Pokud je false, každý může množit všechno

    -- Definice jobů a povolených modelů podle frakce (grade)
    -- Pokud chceš povolit nějaké koně i pro normální hráče bez jobu, vytvoř sekci ["none"]
    jobs = {
        ["breeder1"] = {
            "a_c_horse_turkoman_silver", "a_c_horse_turkoman_perlino",
            "a_c_horse_turkoman_grey","a_c_horse_turkoman_gold",
            "a_c_horse_turkoman_darkbay","a_c_horse_turkoman_chestnut",
            "a_c_horse_turkoman_black"
        },

        ["none"] = {
            "A_C_Horse_Morgan_Bay", "A_C_Horse_Morgan_BayRoan",
            "A_C_Horse_Morgan_FlaxenChestnut", "A_C_Horse_Morgan_Bay",
            "a_c_horse_morgan_liverchestnut_pc","a_c_horse_morgan_palomino"
        }
    }
}

Config.wrongRandomColor = {
    [34] = true,
    [70] = true,
    [87] = true,
    [157] = true,
